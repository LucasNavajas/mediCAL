    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                frecuencia.setNombreFrecuencia("Cada "+ numberPicker.getValue() + " semanas");
                frecuencia.setCantidadFrecuencia(numberPicker.getValue()*24*7);
                recordatorioApi.getByCodRecordatorio(getIntent().getIntExtra("codRecordatorio", 0)).enqueue(new Callback<Recordatorio>() {
                    ...
                    public void onResponse(Call<Recordatorio> call, Response<Recordatorio> response) {
                        ...
                        frecuenciaApi.save(frecuencia).enqueue(new Callback<Frecuencia>() {
                            ...
                            public void onResponse(Call<Frecuencia> call, Response<Frecuencia> response) {
                                ...
                                recordatorioApi.modificarRecordatorio(recordatorio).enqueue(new Callback<Recordatorio>() {
                                    ...
                                    public void onFailure(Call<Recordatorio> call, Throwable t) {
                                        Toast.makeText(FrecuenciaxsemanasActivity.this, "Error al agregar frecuencia al recordatorio", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                            ...
                            public void onFailure(Call<Frecuencia> call, Throwable t) {
                                Toast.makeText(FrecuenciaxsemanasActivity.this, "Error al crear frecuencia", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    @Override
                    public void onFailure(Call<Recordatorio> call, Throwable t) {
                        Toast.makeText(FrecuenciaxsemanasActivity.this, "Error al obtener el recordatorio", Toast.LENGTH_SHORT).show();
                    }
                });
