        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (usuario!=null){
                    ...
                    Intent intent = new Intent(MainActivity.this, AgregarImagenRecordatorioActivity.class); //cambiar el segundo parametro por el nombre de la actividad a probar
