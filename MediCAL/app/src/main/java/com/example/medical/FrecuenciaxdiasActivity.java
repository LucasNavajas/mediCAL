...
public class FrecuenciaxdiasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.n40_cada_x_dias);
        ...
        buttonSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(FrecuenciaxdiasActivity.this, SeleccionarHorarioRecordatorioActivity.class);
                Frecuencia frecuencia = new Frecuencia();
                frecuencia.setNombreFrecuencia("Cada "+ numberPicker.getValue() + " días");
                frecuencia.setCantidadFrecuencia(numberPicker.getValue()*24);
                recordatorioApi.getByCodRecordatorio(getIntent().getIntExtra("codRecordatorio", 0)).enqueue(new Callback<Recordatorio>() {
                    ...
                    public void onResponse(Call<Recordatorio> call, Response<Recordatorio> response) {
                        ...
                        frecuenciaApi.save(frecuencia).enqueue(new Callback<Frecuencia>() {
                            ...
                            public void onResponse(Call<Frecuencia> call, Response<Frecuencia> response) {
                                ...
                                recordatorioApi.modificarRecordatorio(recordatorio).enqueue(new Callback<Recordatorio>() {
                                    ...
                                    public void onFailure(Call<Recordatorio> call, Throwable t) {
                                        Toast.makeText(FrecuenciaxdiasActivity.this, "Error al agregar frecuencia al recordatorio", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                            ...
                            public void onFailure(Call<Frecuencia> call, Throwable t) {
                                Toast.makeText(FrecuenciaxdiasActivity.this, "Error al crear frecuencia", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    @Override
                    public void onFailure(Call<Recordatorio> call, Throwable t) {
                        Toast.makeText(FrecuenciaxdiasActivity.this, "Error al obtener el recordatorio", Toast.LENGTH_SHORT).show();
                    }
                });
