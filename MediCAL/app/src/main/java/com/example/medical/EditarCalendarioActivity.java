...
public class EditarCalendarioActivity extends AppCompatActivity {
    ...
    private ImageView editarRelacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.n17_0_editar_calendario_particular);//cambiar esta linea por el nombre del layout a probar
        ...
        editarRelacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            ...
            public void onClick(View view) {
                ...
                calendarioApi.modificarCalendario(calendarioTemp.getCodCalendario(), calendarioTemp).enqueue(new Callback<Calendario>() {
                    ...
                    public void onFailure(Call<Calendario> call, Throwable t) {
                        Toast.makeText(EditarCalendarioActivity.this, "Hubo un error al guardar el calendario, intente nuevamente", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
            ...
            public void onClick(View view) {
                calendarioApi.eliminarCalendario(calendario.getCodCalendario()).enqueue(new Callback<Void>() {
                    ...
                    public void onFailure(Call<Void> call, Throwable t) {
                        Toast.makeText(EditarCalendarioActivity.this, "Hubo un error al eliminar el calendario, intente nuevamente", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void inicializarVariables() {
        ...
        editarRelacion = findViewById(R.id.lapiz_editar_nombreRelacion);
