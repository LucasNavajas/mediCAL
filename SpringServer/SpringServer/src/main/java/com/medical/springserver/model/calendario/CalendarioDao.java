...
public class CalendarioDao {
	...
	public Calendario findByCodCalendario(int codCalendario) {
	 ...
	 public Calendario modificarCalendario(int id, LocalDate fechaAlta, LocalDate fechaFin, String nombre, String relacion, String paciente) {
	        	Calendario calendario = repository.findByCodCalendario(id);
